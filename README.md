...
- ダウンロード / Download → [Releases](../../releases)
- 必要なもの / Requirements → Blender 4.2+, Reduced CSDK 12, Steam, Deadlock Mod Manager
- ライセンス / License → MIT（[LICENSE](LICENSE)）

個人が趣味で作ったもの。無保証・サポートなし。
A hobby project: no warranty, no support.
